...
This guide assumes you already have a working Slack app that functions in at least one workspace, even if it's just your development workspace. You'll need a Slack developer account with access to [api.slack.com/apps](https://api.slack.com/apps), and your app's source should be under version control since we'll be making structural changes throughout.
